import{z as l}from"./index-CNLKCF2g.js";function p(r,d={}){if(!r)return"No request data available";let i=d.providerGroup;!i&&d.providerId&&(i=l.getProvider(d.providerId)?.group),i=i||d.providerId||"PROVIDER";const t=`${i.toUpperCase()}_API_KEY`;let o=`curl -X POST ${r.url} \\
