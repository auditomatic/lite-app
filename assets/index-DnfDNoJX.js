const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jszip.min-BnfdT0bo.js","assets/ui-vendor-DDlYs5wr.js","assets/vue-vendor-DPw1dQYc.js","assets/utils-vendor-DcTsQz_8.js","assets/data-vendor-B7q_-eFq.js"])))=>i.map(i=>d[i]);
var A=Object.defineProperty;var I=(p,e,r)=>e in p?A(p,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):p[e]=r;var w=(p,e,r)=>I(p,typeof e!="symbol"?e+"":e,r);import{a as c,_ as j}from"./index-CLqmclCd.js";import{t as C,E,g as R,d as S}from"./TrialsViewV3-DHM9NHU_.js";import{TrialBundleExportService as D}from"./trial-bundle.service-CdlNNBiq.js";import"./vue-vendor-DPw1dQYc.js";import"./ui-vendor-DDlYs5wr.js";import"./utils-vendor-DcTsQz_8.js";import"./useCostEstimation-BHyER1Rm.js";import"./ParserSelector-CfTJnZYl.js";import"./parser.store-C-xrBLcz.js";import"./trial-stream-manager-v4-Dxu4ZBoq.js";import"./execution-control-v4-Do2ONpyi.js";import"./useV4TrialCommands-BKLB8XcC.js";import"./useHeatmapStylingV3-CCIdVOn4.js";import"./data-vendor-B7q_-eFq.js";import"./useV4Models-DW3W6hWL.js";import"./useV4LiveQuery-B-RpOK8L.js";class O{getTemplate(){return{id:"minimal",name:"Minimal Experiment Script",description:"Minimal Python script with clear experimental design and pre-built requests",pythonVersion:"3.8",requiredImports:["json","requests","itertools","csv"],templateCode:"MINIMAL_TEMPLATE",supportsAnalysis:!1,supportsVisualization:!1}}generateScript(e,r,t={}){const{includeComments:s=!0}=t,n=this.buildResolvedConfigurations(e);return[this.generateHeader(e,s),this.generateImports(),this.generateExperimentSection(e,s),this.generateResolvedConfigsSection(n,s),this.generateMinimalUtilities(),this.generateExecutionSection(e,s)].filter(Boolean).join(`
...
`}}const ne=new L;export{ne as reproducibilityBundleService};
