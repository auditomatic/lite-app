...
def extract_complex(content):
    ...
    return None`}];function T(_){const d=_.code.match(/def\s+(\w+)\s*\(/),f=d?d[1]:e.modelValue.functionName;i("update:modelValue",{code:_.code,functionName:f,timeout:e.modelValue.timeout})}return(_,d)=>{const f=q,V=W,S=Q,m=xe,u=ee,k=X;return g(),C("div",qe,[n(f,{label:"Code"},{default:r(()=>[n(Ae,{modelValue:o.value,"onUpdate:modelValue":d[0]||(d[0]=c=>o.value=c),languages:[["python","Python"]],"line-nums":!0,theme:"github-dark",height:"350px",width:"100%","font-size":"14px","copy-code":!0,placeholder:`import re
