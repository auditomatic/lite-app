const e=[{id:"extract-first-number-from-json-javascript",name:"Extract First Number from JSON (JS)",description:"Extract first number from JSON, no fallback",type:"javascript",revision:2,config:{code:`// Extract first numeric value from JSON in text, NO FALLBACK
