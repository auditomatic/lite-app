...
import textcounts`)],-1)])),_:1})]),_:1})]),_:1}),n(k,{ghost:""},{default:r(()=>[n(u,{key:"templates",header:"Code Templates"},{default:r(()=>[l("div",He,[(g(),C(Z,null,K(N,c=>l("div",{key:c.name,class:"code-template",onClick:x=>V(c)},[l("div",Ze,E(c.name),1),l("div",Ke,E(c.description),1)],8,Ye)),64))])]),_:1})]),_:1})])}}}),Xe=M(Qe,[["__scopeId","data-v-2efb5717"]]),et={class:"parser-editor-page"},tt={class:"header-content"},at={class:"page-title"},nt={class:"editor-container"},ot={key:0,class:"loading-container"},rt={key:1,class:"editor-form"},st={class:"form-section"},lt={class:"form-row"},it={class:"form-row"},ut={class:"form-section"},ct={class:"footer-content"},dt={class:"footer-stats"},pt={key:0},mt={key:1},_t={key:0,class:"footer-validation"},ft={class:"validation-error"},vt={key:0},gt={key:1},yt={key:2},ht={key:3},xt={key:4,class:"pattern-error"},Ct={class:"footer-actions"},wt=J({__name:"ParserEditor",setup(R){const w=me(),e=_e(),i=h(()=>w.params.id),{form:o,patternError:y,patternWarning:P,patternChecking:N,saving:V,loading:_,isEditingBuiltIn:d,isValid:f,currentParser:T,validateRegexPattern:S,loadParser:m,save:u,setTypeDefaults:k}=Ie(i),c=h({get:()=>({pattern:o.value.regexPattern,flags:o.value.regexFlags,captureGroup:o.value.regexCaptureGroup}),set:a=>{o.value.regexPattern=a.pattern,o.value.regexFlags=a.flags,o.value.regexCaptureGroup=a.captureGroup}}),x=h({get:()=>({code:o.value.pythonCode,functionName:o.value.pythonFunctionName,timeout:o.value.pythonTimeout}),set:a=>{o.value.pythonCode=a.code,o.value.pythonFunctionName=a.functionName,o.value.pythonTimeout=a.timeout}});function I(a){k(a)}async function O(){try{await u();const a=d.value?"New parser created successfully":i.value?"Parser updated successfully":"Parser created successfully";j.success(a),e.push(D)}catch(a){j.error(a instanceof Error?a.message:"Failed to save parser")}}function $(){e.push(D)}function U(a){o.value.testCases=a}return pe(async()=>{if(i.value)try{await m(i.value)}catch{j.error("Failed to load parser"),e.push(D)}else{const a=w.query.type;a&&k(a)}}),(a,t)=>{const p=be,B=we,te=Ne,ae=W,G=q,A=Te,L=Ve,ne=Se,oe=Ee,re=ke,se=Fe,le=Ce;return g(),C("div",et,[n(le,null,{default:r(()=>[n(B,{class:"editor-header"},{default:r(()=>[l("div",tt,[n(p,{type:"text",onClick:$,class:"back-button"},{icon:r(()=>[n(s(Pe))]),default:r(()=>[t[7]||(t[7]=v(" Back to Parsers "))]),_:1,__:[7]}),l("h1",at,E(s(d)?"Copy Built-in Parser":i.value?"Edit Parser":"Create Parser"),1)])]),_:1}),n(re,{class:"editor-content"},{default:r(()=>[l("div",nt,[s(_)?(g(),C("div",ot,[n(te,{size:"large",tip:"Loading parser..."})])):(g(),C("div",rt,[n(oe,{model:s(o),layout:"vertical"},{default:r(()=>[l("div",st,[t[14]||(t[14]=l("div",{class:"section-header"},[l("h3",null,"Basic Information")],-1)),l("div",lt,[n(G,{label:"Name",rules:[{required:!0,message:"Name is required"}],class:"form-item"},{default:r(()=>[n(ae,{value:s(o).name,"onUpdate:value":t[0]||(t[0]=b=>s(o).name=b),placeholder:"Enter parser name",size:"large"},null,8,["value"])]),_:1}),n(G,{label:"Type",class:"form-item"},{default:r(()=>[n(L,{value:s(o).type,"onUpdate:value":t[1]||(t[1]=b=>s(o).type=b),size:"large",disabled:!!i.value,onChange:I},{default:r(()=>[n(A,{value:"regex"},{default:r(()=>t[8]||(t[8]=[v("Regular Expression")])),_:1,__:[8]}),n(A,{value:"python"},{default:r(()=>t[9]||(t[9]=[v("Python")])),_:1,__:[9]})]),_:1},8,["value","disabled"])]),_:1})]),l("div",it,[n(G,{label:"Output Type",class:"form-item"},{default:r(()=>[n(L,{value:s(o).outputType,"onUpdate:value":t[2]||(t[2]=b=>s(o).outputType=b),size:"large"},{default:r(()=>[n(A,{value:"text"},{default:r(()=>t[10]||(t[10]=[v("Text")])),_:1,__:[10]}),n(A,{value:"number"},{default:r(()=>t[11]||(t[11]=[v("Number")])),_:1,__:[11]}),n(A,{value:"boolean"},{default:r(()=>t[12]||(t[12]=[v("Boolean")])),_:1,__:[12]}),n(A,{value:"json"},{default:r(()=>t[13]||(t[13]=[v("JSON")])),_:1,__:[13]})]),_:1},8,["value"])]),_:1}),n(G,{label:"Tags",class:"form-item"},{default:r(()=>[n(L,{value:s(o).tags,"onUpdate:value":t[3]||(t[3]=b=>s(o).tags=b),mode:"tags",placeholder:"Add tags for search",size:"large"},null,8,["value"])]),_:1})]),n(G,{label:"Description",class:"form-item full-width"},{default:r(()=>[n(ne,{spellcheck:"true",value:s(o).description,"onUpdate:value":t[4]||(t[4]=b=>s(o).description=b),placeholder:"Optional description of what this parser does",rows:2,size:"large"},null,8,["value"])]),_:1})]),l("div",ut,[t[15]||(t[15]=l("div",{class:"section-header"},[l("h3",null,"Parser Configuration")],-1)),s(o).type==="regex"?(g(),Y(Je,{key:0,modelValue:c.value,"onUpdate:modelValue":t[5]||(t[5]=b=>c.value=b),error:s(y),warning:s(P),checking:s(N),onValidate:s(S)},null,8,["modelValue","error","warning","checking","onValidate"])):s(o).type==="python"?(g(),Y(Xe,{key:1,modelValue:x.value,"onUpdate:modelValue":t[6]||(t[6]=b=>x.value=b)},null,8,["modelValue"])):F("",!0)]),n(ve,{parser:s(T),form:s(o),"auto-save-tests":!0,"onUpdate:testCases":U},null,8,["parser","form"])]),_:1},8,["model"])]))])]),_:1}),n(se,{class:"editor-footer"},{default:r(()=>[l("div",ct,[l("div",dt,[s(o).type==="regex"&&c.value.pattern?(g(),C("span",pt," Pattern: "+E(c.value.pattern.length)+" chars ",1)):s(o).type==="python"&&x.value.code?(g(),C("span",mt," Code: "+E(x.value.code.split(`
