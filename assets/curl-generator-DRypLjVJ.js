import{e as t}from"./index-CrG7-9Wd.js";function p(r,d={}){if(!r)return"No request data available";let i=d.providerGroup;!i&&d.providerId&&(i=t.getProvider(d.providerId)?.group),i=i||d.providerId||"PROVIDER";const n=`${i.toUpperCase()}_API_KEY`;let o=`curl -X POST ${r.url} \\
