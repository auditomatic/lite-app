const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jszip.min-D3Xeuhb_.js","assets/ui-vendor-B0yHHe2_.js","assets/vue-vendor-CPJ68Jbj.js","assets/utils-vendor-_jglodAS.js","assets/data-vendor-CpdOIf_3.js","assets/ExportDataModal-wNUsKNJM.js","assets/tauri-download-utilities-BlhhN17H.js","assets/index-l2Mia_eP.js","assets/tauri-vendor-BdAyolxU.js","assets/index-BKo78Xzj.css","assets/dataset-operations-B3gt2no2.js","assets/id-generator-Cv_Imc0S.js","assets/useCrossTab-PYvzJWR1.js","assets/row-filters-DVNsrKUs.js","assets/sql-wasm-DjBhETmX.js","assets/api-call-bodies-zPzypjL6.js","assets/ColumnFilterPanel-ln2PJ5eI.js","assets/display-values-D3R-R7BQ.js","assets/sanitization-Cf7uRbG5.js","assets/ColumnFilterPanel-sHmn1N6g.css","assets/repository-0GdVMeGt.js","assets/repository-BA9qj2vM.js","assets/ExportDataModal-B0x4XJZM.css"])))=>i.map(i=>d[i]);
var V=Object.defineProperty;var z=(g,e,t)=>e in g?V(g,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):g[e]=t;var C=(g,e,t)=>z(g,typeof e!="symbol"?e+"":e,t);import{l as m,c as H,d as K,_ as q}from"./index-l2Mia_eP.js";import{t as U,a as P,g as F,T as X,d as j}from"./ExportDataModal-wNUsKNJM.js";import{a as G}from"./index-C_81O1vp.js";import"./vue-vendor-CPJ68Jbj.js";import"./ui-vendor-B0yHHe2_.js";import"./utils-vendor-_jglodAS.js";import"./tauri-vendor-BdAyolxU.js";import"./tauri-download-utilities-BlhhN17H.js";import"./dataset-operations-B3gt2no2.js";import"./id-generator-Cv_Imc0S.js";import"./useCrossTab-PYvzJWR1.js";import"./row-filters-DVNsrKUs.js";import"./data-vendor-CpdOIf_3.js";import"./sql-wasm-DjBhETmX.js";import"./api-call-bodies-zPzypjL6.js";import"./ColumnFilterPanel-ln2PJ5eI.js";import"./display-values-D3R-R7BQ.js";import"./sanitization-Cf7uRbG5.js";import"./repository-0GdVMeGt.js";import"./repository-BA9qj2vM.js";class w{getTemplate(){return{id:"simple",name:"Simple Script (Beginner-Friendly)",description:"Simple Python script with CSV/JSON output, basic retries, and clear progress. Best for beginners and quick tests.",pythonVersion:"3.8",requiredImports:["json","requests","jmespath","os","time","datetime"],templateCode:"SIMPLE_TEMPLATE",supportsAnalysis:!1,supportsVisualization:!1}}generateScript(e,t,s={}){const{includeComments:r=!0}=s,a=this.buildResolvedConfigurations(e),n=this.discoverParameterColumns(a);return[this.generateHeader(e,r),this.generateImports(),this.generateSettings(e,r),this.generateParameterColumns(n,r),this.generateModelConfigs(a,r),this.generateFunctions(),this.generateMainFunction(e,n),this.generateExecutor()].filter(Boolean).join(`
...
requests>=2.28.0
`}async addDatasetParquet(e,t,s){if(!(t.type!=="spreadsheet"||!t.spreadsheetConfig))try{const r=await K.datasets.get(t.spreadsheetConfig.datasetId);if(!r){m.warn("Dataset not found for spreadsheet trial");return}const{parquetGenerator:a}=await q(async()=>{const{parquetGenerator:o}=await import("./ExportDataModal-wNUsKNJM.js").then(i=>i.i);return{parquetGenerator:o}},__vite__mapDeps([5,6,7,2,1,3,8,9,10,11,12,13,4,14,15,16,17,18,19,20,21,22])),n=a.generate(r);e.file("data.parquet",n),s.push("data.parquet"),m.debug("EXPORT_DEBUG: Added dataset parquet to bundle",{rows:r.rows.length,columns:r.columns.length,sizeBytes:n.byteLength})}catch(r){m.error("Failed to add dataset parquet:",r)}}}const Se=new se;export{Se as reproducibilityBundleService};
