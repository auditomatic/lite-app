...
def extract_complex(content):
    ...
    return None`}];function E(v){const c=v.code.match(/def\s+(\w+)\s*\(/),N=c?c[1]:e.modelValue.functionName;d("update:modelValue",{code:v.code,functionName:N,timeout:e.modelValue.timeout})}return(v,c)=>{const N=L,m=D,p=Z,S=ce,C=X,g=H;return y(),x("div",Ae,[t(N,{label:"Code"},{default:n(()=>[t(we,{modelValue:a.value,"onUpdate:modelValue":c[0]||(c[0]=o=>a.value=o),languages:[["python","Python"]],"line-nums":!0,theme:"github-dark",height:"350px",width:"100%","font-size":"14px","copy-code":!0,placeholder:`import re
