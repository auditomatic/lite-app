...
def extract_complex(content):
    ...
    return None`}];function x(p){const d=p.code.match(/def\s+(\w+)\s*\(/),k=d?d[1]:e.modelValue.functionName;i("update:modelValue",{code:p.code,functionName:k,timeout:e.modelValue.timeout})}return(p,d)=>{const k=A,f=Y,m=W,C=me,P=H,N=Z;return _(),g("div",De,[a(k,{label:"Code"},{default:o(()=>[a(Q,{modelValue:t.value,"onUpdate:modelValue":d[0]||(d[0]=n=>t.value=n),languages:[["python","Python"]],"line-nums":!0,theme:"github-dark",height:"350px",width:"100%","font-size":"14px","copy-code":!0,placeholder:`import re
