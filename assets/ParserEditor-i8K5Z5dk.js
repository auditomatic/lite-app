import{r as $,h as b,d as B,_ as y,U as x,n as t,a0 as n,V as l,J as f,F as q,W as Y,Y as T,b as re,a4 as se,a3 as le,u as s,a2 as M,Z as F}from"./vue-vendor-CDyndH2W.js";import{t as U}from"./toast-1lfSrllP.js";import{u as ue}from"./parser-DVix1idi.js";import{h as J,v as L}from"./index-8DjmAhVs.js";import{e as j,I as D,aF as ie,x as de,l as Z,d as H,c as W,b as ce,u as pe,H as me,B as _e,A as fe,L as ve,S as ge,F as ye,f as he,h as xe,q as Ce,y as be,G as Pe}from"./ui-vendor-BRLkBnr8.js";import{C as we}from"./CodeEditor-C17fizk4.js";import{P as Ne}from"./ParserTestSectionCompact-6zDMd3L4.js";import"./utils-vendor-B6jgDG95.js";import"./tauri-vendor-BdAyolxU.js";function Ve(z){const P=ue(),e=$({name:"",description:"",type:"regex",outputType:"text",tags:[],regexPattern:"",regexFlags:"",regexCaptureGroup:1,pythonCode:`def extract_data(content):
...
def extract_complex(content):
    ...
    return None`}];function E(v){const c=v.code.match(/def\s+(\w+)\s*\(/),N=c?c[1]:e.modelValue.functionName;d("update:modelValue",{code:v.code,functionName:N,timeout:e.modelValue.timeout})}return(v,c)=>{const N=j,m=D,p=Z,S=ce,C=W,g=H;return y(),x("div",Ae,[t(N,{label:"Code"},{default:n(()=>[t(we,{modelValue:a.value,"onUpdate:modelValue":c[0]||(c[0]=o=>a.value=o),languages:[["python","Python"]],"line-nums":!0,theme:"github-dark",height:"350px",width:"100%","font-size":"14px","copy-code":!0,placeholder:`import re
