import{f as O,c as b,d as I,R as g,V as _,k as a,S as l,U as o,G as y,F as M,Z as q,Y as T,a1 as le,o as ue,_ as ie,u as s,X as L,W as $}from"./vue-vendor-BQHtwQ0z.js";import{u as ce}from"./parser.store-DtPvAzW2.js";import{c as X,k as U}from"./index-CdxCdnK3.js";import{w as A,a4 as Y,ah as de,ai as pe,aj as Z,ak as W,al as H,z as me,G as D,ab as _e,ac as fe,B as ve,ad as ge,ae as ye,O as he,a7 as xe,a5 as Ce,a6 as be,x as we,af as Pe,ag as Ve}from"./ui-vendor-CRxSYXyc.js";import{C as K}from"./CodeEditorWrapper-CajlqQxR.js";import{P as Ne}from"./ParserTestSectionCompact-DMDr8DW5.js";import"./tauri-vendor-1uBLmS9u.js";import"./utils-vendor-CpuEF_u3.js";function ke(F){const w=ce(),e=O({name:"",description:"",type:"regex",outputType:"text",tags:[],regexPattern:"",regexFlags:"",regexCaptureGroup:1,javascriptCode:`// Return extracted value
...
def extract_complex(content):
    ...
    return None`}];function x(p){const d=p.code.match(/def\s+(\w+)\s*\(/),k=d?d[1]:e.modelValue.functionName;i("update:modelValue",{code:p.code,functionName:k,timeout:e.modelValue.timeout})}return(p,d)=>{const k=A,f=Y,m=Z,C=me,P=H,V=W;return _(),g("div",De,[a(k,{label:"Code"},{default:o(()=>[a(K,{modelValue:t.value,"onUpdate:modelValue":d[0]||(d[0]=n=>t.value=n),languages:[["python","Python"]],"line-nums":!0,theme:"github-dark",height:"350px",width:"100%","font-size":"14px","copy-code":!0,placeholder:`import re
