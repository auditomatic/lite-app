const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jszip.min-BvaFI05w.js","assets/ui-vendor-fVIvODcL.js","assets/vue-vendor-Bj1RkBNK.js","assets/utils-vendor-6tkXQoHS.js","assets/data-vendor-CDv21Lmu.js","assets/TrialsView-Bt7wnerr.js","assets/index-Dt_9U6NJ.js","assets/tauri-vendor-BdAyolxU.js","assets/index-BElL-pwQ.css","assets/toast-BOVrlUQj.js","assets/useCostEstimation-BssAFbLW.js","assets/costs-DslnZrF8.js","assets/cost-calculation-Bc65RwZW.js","assets/useModels-ziyXpIgp.js","assets/useLiveQuery-CxBuvkqj.js","assets/index-Bbu6fcLL.js","assets/executor-Bs50UReM.js","assets/curl-generator-BnlvV_7O.js","assets/useHeatmapStyling-BmLy5cDA.js","assets/tauri-download-utilities-CevOoI98.js","assets/sql-wasm-H4oLBAPa.js","assets/ParserSelector-Bskmr_kg.js","assets/parser-CxEUsVVI.js","assets/ParserSelector-DbffjY7a.css","assets/useTrialCommands-DYgIpATD.js","assets/repository-B7kDKkSw.js","assets/id-generator-Cv_Imc0S.js","assets/controller-LwFAuSVc.js","assets/repository-D9SViPBJ.js","assets/TrialsView-BDSgsrZX.css"])))=>i.map(i=>d[i]);
var z=Object.defineProperty;var V=(g,e,t)=>e in g?z(g,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):g[e]=t;var C=(g,e,t)=>V(g,typeof e!="symbol"?e+"":e,t);import{l as m,c as H,d as K,_ as D}from"./index-Dt_9U6NJ.js";import{t as U,E as P,g as F,d as j}from"./TrialsView-Bt7wnerr.js";import{a as G}from"./index-Bbu6fcLL.js";import{TrialBundleExportService as X}from"./trial-bundle.service-BAxcldLX.js";import"./vue-vendor-Bj1RkBNK.js";import"./ui-vendor-fVIvODcL.js";import"./utils-vendor-6tkXQoHS.js";import"./tauri-vendor-BdAyolxU.js";import"./toast-BOVrlUQj.js";import"./useCostEstimation-BssAFbLW.js";import"./costs-DslnZrF8.js";import"./cost-calculation-Bc65RwZW.js";import"./useModels-ziyXpIgp.js";import"./useLiveQuery-CxBuvkqj.js";import"./executor-Bs50UReM.js";import"./curl-generator-BnlvV_7O.js";import"./useHeatmapStyling-BmLy5cDA.js";import"./tauri-download-utilities-CevOoI98.js";import"./data-vendor-CDv21Lmu.js";import"./sql-wasm-H4oLBAPa.js";import"./ParserSelector-Bskmr_kg.js";import"./parser-CxEUsVVI.js";import"./useTrialCommands-DYgIpATD.js";import"./repository-B7kDKkSw.js";import"./id-generator-Cv_Imc0S.js";import"./controller-LwFAuSVc.js";import"./repository-D9SViPBJ.js";class w{getTemplate(){return{id:"simple",name:"Simple Script (Beginner-Friendly)",description:"Simple Python script with CSV/JSON output, basic retries, and clear progress. Best for beginners and quick tests.",pythonVersion:"3.8",requiredImports:["json","requests","jmespath","os","time","datetime"],templateCode:"SIMPLE_TEMPLATE",supportsAnalysis:!1,supportsVisualization:!1}}generateScript(e,t,s={}){const{includeComments:r=!0}=s,a=this.buildResolvedConfigurations(e),n=this.discoverParameterColumns(a);return[this.generateHeader(e,r),this.generateImports(),this.generateSettings(e,r),this.generateParameterColumns(n,r),this.generateModelConfigs(a,r),this.generateFunctions(),this.generateMainFunction(e,n),this.generateExecutor()].filter(Boolean).join(`

`)}buildResolvedConfigurations(e){const t=[],s=new Map,r=new Map;for(const a of e.configurations){const n=a.modelSnapshot?.displayName||a.modelId;s.set(n,(s.get(n)||0)+1),r.set(n,0)}for(let a=0;a<e.configurations.length;a++){const n=e.configurations[a],o=n.providerSnapshot;if(!o)continue;const i=o.api?.baseUrl||"https://api.example.com",c=o.api?.endpoint||"/v1/api",l={"Content-Type":"application/json",...o.headers};o.auth?.type==="bearer"?l.Authorization="Bearer {{API_KEY}}":o.auth?.type==="header"&&o.auth.header&&(l[o.auth.header]="{{API_KEY}}");const d={model:n.modelId},_=o.bodyConstruction;_?.promptField?_.wrapAsArray?d[_.promptField]=[{role:_.messageRole||"user",content:"{{PROMPT}}"}]:d[_.promptField]="{{PROMPT}}":d.prompt="{{PROMPT}}",Object.assign(d,n.parameters);const h=n.provider.split("-")[0],u=n.modelSnapshot?.displayName||n.modelId;let y=u;if(s.get(u)>1){const p=r.get(u)+1;r.set(u,p),y=`${u} [Config ${p}]`}const b=this.getExtractPaths(n);t.push({config_index:a,name:u,display_name:y,provider:h,url:i+c,headers:l,body:d,parameters:n.parameters||{},extract_paths:b.contentPaths,reasoning_paths:b.reasoningPaths})}return t}getExtractPaths(e){const t=e.providerSnapshot;if(!t)return{contentPaths:["response"],reasoningPaths:[]};const s=t.responseModes?.text;if(!s)return{contentPaths:["response"],reasoningPaths:[]};const r=s.responseTransform;if(!r)return{contentPaths:["response"],reasoningPaths:[]};const a=[];r.contentPath&&a.push(r.contentPath),r.fallbackPaths&&a.push(...r.fallbackPaths);const n=[];return r.reasoningPath&&n.push(r.reasoningPath),r.reasoningFallbackPaths&&n.push(...r.reasoningFallbackPaths),{contentPaths:a.length>0?a:["response"],reasoningPaths:n}}discoverParameterColumns(e){const t=new Set;for(const s of e)s.parameters&&Object.keys(s.parameters).forEach(r=>t.add(r));return Array.from(t).sort()}generateParameterColumns(e,t){const s=t?`# All unique parameters found across model configurations
...
`,I="auditomatic_jsonrepair.py",N="3.13.1",M="ef309362963000737d35443766d6607090e64f9a80bdfc635fd7e9042db3149f",Q=`The ISC License
...
`)}buildResolvedConfigurations(e){const t=[],s=new Map,r=new Map;for(const a of e.configurations){const n=a.modelSnapshot?.displayName||a.modelId;s.set(n,(s.get(n)||0)+1),r.set(n,0)}for(let a=0;a<e.configurations.length;a++){const n=e.configurations[a],o=n.providerSnapshot;if(!o)continue;const i=o.api?.baseUrl||"https://api.example.com",c=o.api?.endpoint||"/v1/api",l={"Content-Type":"application/json",...o.headers};o.auth?.type==="bearer"?l.Authorization="Bearer {{API_KEY}}":o.auth?.type==="header"&&o.auth.header&&(l[o.auth.header]="{{API_KEY}}");const d="@@AUDITOMATIC_PROMPT@@",_="@@AUDITOMATIC_SYSTEM@@",h=!!e.templateConfig?.systemPrompt,u=G(o,n.modelId,n.parameters||{},d,h?_:void 0),y=JSON.parse(JSON.stringify(u).split(d).join("{{PROMPT}}").split(_).join("{{SYSTEM_PROMPT}}")),b=n.provider.split("-")[0],p=n.modelSnapshot?.displayName||n.modelId;let f=p;if(s.get(p)>1){const x=r.get(p)+1;r.set(p,x),f=`${p} [Config ${x}]`}const v=this.getExtractPaths(n);t.push({config_index:a,name:p,display_name:f,provider:b,url:i+c,headers:l,body:y,parameters:n.parameters||{},extract_paths:v.contentPaths,reasoning_paths:v.reasoningPaths})}return t}getExtractPaths(e){const t=e.providerSnapshot;if(!t)return{contentPaths:["response"],reasoningPaths:[]};const s=t.responseModes?.text;if(!s)return{contentPaths:["response"],reasoningPaths:[]};const r=s.responseTransform;if(!r)return{contentPaths:["response"],reasoningPaths:[]};const a=[];r.contentPath&&a.push(r.contentPath),r.fallbackPaths&&a.push(...r.fallbackPaths);const n=[];return r.reasoningPath&&n.push(r.reasoningPath),r.reasoningFallbackPaths&&n.push(...r.reasoningFallbackPaths),{contentPaths:a.length>0?a:["response"],reasoningPaths:n}}discoverParameterColumns(e){const t=new Set;for(const s of e)s.parameters&&Object.keys(s.parameters).forEach(r=>t.add(r));return Array.from(t).sort()}generateParameterColumns(e,t){const s=t?`# All unique parameter names found across model configurations
...
`:"";let r="";if(e.type==="template"&&e.templateConfig){const{template:o,variables:i}=e.templateConfig;let c=!1;const l={},d={};for(const[u,y]of Object.entries(i))if("snapshot"in y&&y.snapshot){const b=y.snapshot.items;if(b.some(f=>f.attributes&&Object.keys(f.attributes).length>0)){c=!0,d[u]=b.map(v=>({value:v.value,attributes:v.attributes||{}}));const f=new Set;b.forEach(v=>{v.attributes&&Object.keys(v.attributes).forEach(x=>f.add(x))}),l[u]=Array.from(f).sort()}else d[u]=b.map(f=>f.value)}else y.type==="value"&&y.values&&(d[u]=[...y.values]);const _=JSON.stringify(d,null,4).replace(/: false/g,": False").replace(/: true/g,": True").replace(/: null/g,": None"),h=t?`# Variables support two formats:
