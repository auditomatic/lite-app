import{f as I,c as b,d as U,R as g,Z as _,k as a,S as l,U as o,G as y,F as M,W as q,X as T,a2 as le,o as ue,$ as ie,u as s,Y as L,V as $}from"./vue-vendor-B9kxdhiN.js";import{u as ce}from"./parser-DdSITNAN.js";import{c as X,j as G}from"./index-DS6BF8q6.js";import{l as A,an as Y,az as de,a6 as pe,aA as Z,ab as H,ac as W,n as me,q as D,ar as _e,as as fe,B as ve,a8 as ge,at as ye,H as he,ao as xe,a7 as Ce,a9 as be,m as we,au as Pe,av as Ne}from"./ui-vendor-DAUGyC0h.js";import{C as K}from"./CodeEditor-CMCcBsdx.js";import{P as Ve}from"./ParserTestSectionCompact-Cpg8IusU.js";import"./tauri-vendor-1uBLmS9u.js";import"./utils-vendor-pFqI4y6K.js";function ke(F){const w=ce(),e=I({name:"",description:"",type:"regex",outputType:"text",tags:[],regexPattern:"",regexFlags:"",regexCaptureGroup:1,javascriptCode:`// Return extracted value
...
def extract_complex(content):
    ...
    return None`}];function x(p){const d=p.code.match(/def\s+(\w+)\s*\(/),k=d?d[1]:e.modelValue.functionName;i("update:modelValue",{code:p.code,functionName:k,timeout:e.modelValue.timeout})}return(p,d)=>{const k=A,f=Y,m=Z,C=me,P=W,N=H;return _(),g("div",De,[a(k,{label:"Code"},{default:o(()=>[a(K,{modelValue:t.value,"onUpdate:modelValue":d[0]||(d[0]=n=>t.value=n),languages:[["python","Python"]],"line-nums":!0,theme:"github-dark",height:"350px",width:"100%","font-size":"14px","copy-code":!0,placeholder:`import re
